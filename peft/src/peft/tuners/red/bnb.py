...
from .layer import REDLayer


if is_bnb_available():

    class Linear8bitLt(torch.nn.Module, REDLayer):
        ...
        def __init__(
            ...
            **kwargs,
            ...
            super().__init__()
            REDLayer.__init__(self, base_layer, is_feedforward=is_feedforward)
...
if is_bnb_4bit_available():
    ...
    class Linear4bit(torch.nn.Module, REDLayer):
